...
import 'package:online_market/views/product_details/ui/product_details_view.dart';
...
class ProductItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        navTo(context, const ProductDetailsView());
      },
      child: Card(
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  const Spacer(),
                  Expanded(
                    child: CustomEvButton(text: "Buy Now", onTap: () {}),
                  ),
                ],
              ),
            ),
